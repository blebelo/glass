...
{
    public abstract class GlassTicketsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GlassTicketsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GlassTicketsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GlassTicketsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GlassTicketsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GlassTicketsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GlassTicketsDbContext, Task<T>> func)
        {
            T result;

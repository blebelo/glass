...
namespace GlassTickets.Migrations
{
    ...
    partial class Remove_IsActive_From_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("GlassTickets.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("GlassTickets.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("GlassTickets.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("GlassTickets.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("GlassTickets.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("GlassTickets.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
